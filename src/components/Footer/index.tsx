...
const Footer = () => {
  return (
    ...
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Empowering brands with innovative digital strategies that drive measurable results and long-term growth.
              </p>
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li className="mb-3 inline-block text-base text-gray-7">
                  Email: info@quicklytech.in
                </li>
                <li className="mb-3 inline-block text-base text-gray-7">
                  Website: quicklytech.in
                </li>
                <li className="mb-3 inline-block text-base text-gray-7">
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-30 py-8 lg:mt-[60px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <p className="text-base text-gray-7">
                    © {new Date().getFullYear()} Quickly Design Technology Pvt Ltd. All rights reserved.
                  </p>
                </div>
              </div>
            </div>
